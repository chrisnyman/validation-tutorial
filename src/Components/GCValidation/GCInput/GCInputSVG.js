...
class GCInputSVG extends Component {
  render() {
    ...
    switch (type) {
      case 'chevronDown':
      return (
        <svg id="layer_chevronDown" className={className} viewBox="0 0 100 100">
          <title id={type}>
            {type}
          </title>
          ...
          <g id="chevronDown">
            <path
              className="gc-select__input-icon--fill" d="M43.9188,76.5719c3.4249,3.4183,8.98,3.4183,12.4049,0l41.1061-41.0016c3.4268-3.4144,3.4268-8.9595,0-12.374
      ...
      case 'chevronUp':
      return (
        <svg id="layer_chevronUp" className={className} viewBox="0 0 100 100">
          <title id={type}>
            {type}
          </title>
          ...
          <g id="chevronUp">
            <path
              className="gc-select__input-icon--fill" d="M76.9035,42.5457l-19.715-19.7149c-0.8932-0.872-2.1055-1.6589-3.254-2.063c-1.4036-0.6593-2.8711-0.8082-3.8706-0.8082
